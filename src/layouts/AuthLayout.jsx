...
const AuthLayout = ({ children }) => {
  return (
    <div className="min-h-screen flex flex-col md:flex-row font-poppins bg-white transition-colors duration-300">
      <div
        className="
        ...
        "
      >
        <img src={logo} alt="Logo" className="h-48 object-contain transition-all duration-300" />
      </div>
